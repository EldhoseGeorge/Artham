 ...
 * Thanks to the  TypeScript implementation of the Porter Stemmer algorithm, https://github.com/maxpatiiuk/porter-stemming/tree/main
 * This implementation is based on the original Porter Stemmer algorithm.
